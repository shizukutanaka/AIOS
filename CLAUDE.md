...
78 Python + 29 Go commands, 2856+ tests, zero external Python deps. v1.6.0.

## Map
```
aictl/cmd/        78 CLI commands (init doctor ps apply down recipe model capacity ...)
...
tests/            215 test files, 2856+ tests
...
aictl gate                         # Compile + import + version + 2856 tests + demo
