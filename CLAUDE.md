...
80 Python + 29 Go commands, 3751+ tests, zero external Python deps. v1.7.0.
...
tests/            274 test files, 3751+ tests
...
aictl gate                         # Compile + import + version + 3751 tests + demo (~58s)
