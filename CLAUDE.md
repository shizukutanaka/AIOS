...
80 Python + 29 Go commands, 3884+ tests, zero external Python deps. v1.7.0.
...
tests/            281 test files, 3884+ tests
...
aictl gate                         # Compile + import + version + 3884 tests + demo (~58s)
