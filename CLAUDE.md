...
80 Python + 29 Go commands, 3788+ tests, zero external Python deps. v1.7.0.
...
tests/            276 test files, 3788+ tests
...
aictl gate                         # Compile + import + version + 3788 tests + demo (~58s)
