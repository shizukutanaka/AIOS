...
80 Python + 29 Go commands, 3783+ tests, zero external Python deps. v1.7.0.
...
tests/            276 test files, 3783+ tests
...
aictl gate                         # Compile + import + version + 3783 tests + demo (~58s)
