...
77 Python + 29 Go commands, 2529+ tests, zero external Python deps. v1.6.0.

## Map
```
aictl/cmd/        77 CLI commands (init doctor ps apply down recipe model ...)
...
tests/            157 test files, 2529+ tests
...
aictl gate                         # Compile + import + version + 2529 tests + demo
