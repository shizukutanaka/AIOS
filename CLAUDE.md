...
80 Python + 29 Go commands, 3948+ tests, zero external Python deps. v1.7.0.
...
tests/            284 test files, 3948+ tests
...
aictl gate                         # Compile + import + version + 3948 tests + demo (~58s)
