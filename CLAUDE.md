...
80 Python + 29 Go commands, 3814+ tests, zero external Python deps. v1.7.0.
...
tests/            278 test files, 3814+ tests
...
aictl gate                         # Compile + import + version + 3814 tests + demo (~58s)
