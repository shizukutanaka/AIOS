...
80 Python + 29 Go commands, 4104+ tests, zero external Python deps. v1.7.0.
...
tests/            293 test files, 4104+ tests
...
aictl gate                         # 12 phases: compile, import, version, 4104 tests,
