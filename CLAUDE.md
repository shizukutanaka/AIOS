...
80 Python + 29 Go commands, 3830+ tests, zero external Python deps. v1.7.0.
...
tests/            279 test files, 3830+ tests
...
aictl gate                         # Compile + import + version + 3830 tests + demo (~58s)
aictl gate --parallel              # Same, file-per-process (~30s). Serial is the source of truth.
