...
80 Python + 29 Go commands, 3992+ tests, zero external Python deps. v1.7.0.
...
tests/            287 test files, 3992+ tests
...
aictl gate                         # Compile + import + version + 3992 tests + demo (~58s)
