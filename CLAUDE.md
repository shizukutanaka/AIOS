...
80 Python + 29 Go commands, 4063+ tests, zero external Python deps. v1.7.0.
...
tests/            291 test files, 4063+ tests
...
aictl gate                         # 12 phases: compile, import, version, 4063 tests,
