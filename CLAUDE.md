...
70 Python + 29 Go commands, 2153+ tests, zero external Python deps. v1.6.0.

## Map
```
aictl/cmd/        70 CLI commands (init doctor ps apply down recipe model ...)
...
tests/            137 test files, 2153+ tests
...
aictl gate                         # Compile + import + version + 2153 tests + demo
