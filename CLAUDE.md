...
80 Python + 29 Go commands, 3964+ tests, zero external Python deps. v1.7.0.
...
tests/            285 test files, 3964+ tests
...
aictl gate                         # Compile + import + version + 3964 tests + demo (~58s)
