...
80 Python + 29 Go commands, 4106+ tests, zero external Python deps. v1.7.0.
...
tests/            293 test files, 4106+ tests
...
aictl gate                         # 12 phases: compile, import, version, 4106 tests,
