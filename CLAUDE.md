...
80 Python + 29 Go commands, 3996+ tests, zero external Python deps. v1.7.0.
...
tests/            287 test files, 3996+ tests
...
aictl gate                         # Compile + import + version + 3996 tests + demo (~58s)
