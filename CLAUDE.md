...
80 Python + 29 Go commands, 4080+ tests, zero external Python deps. v1.7.0.
...
tests/            292 test files, 4080+ tests
...
aictl gate                         # 12 phases: compile, import, version, 4080 tests,
