...
80 Python + 29 Go commands, 4002+ tests, zero external Python deps. v1.7.0.
...
tests/            287 test files, 4002+ tests
...
aictl gate                         # Compile + import + version + 4002 tests + demo (~58s)
