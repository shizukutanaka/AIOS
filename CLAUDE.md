...
80 Python + 29 Go commands, 3929+ tests, zero external Python deps. v1.7.0.
...
tests/            283 test files, 3929+ tests
...
aictl gate                         # Compile + import + version + 3929 tests + demo (~58s)
