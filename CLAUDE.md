...
80 Python + 29 Go commands, 4023+ tests, zero external Python deps. v1.7.0.
...
tests/            288 test files, 4023+ tests
...
aictl gate                         # Compile + import + version + 4023 tests + demo (~58s)
