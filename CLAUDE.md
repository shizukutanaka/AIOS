...
72 Python + 29 Go commands, 2205+ tests, zero external Python deps. v1.6.0.

## Map
```
aictl/cmd/        72 CLI commands (init doctor ps apply down recipe model ...)
...
tests/            139 test files, 2205+ tests
...
aictl gate                         # Compile + import + version + 2205 tests + demo
