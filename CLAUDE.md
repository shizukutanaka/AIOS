...
80 Python + 29 Go commands, 3978+ tests, zero external Python deps. v1.7.0.
...
tests/            286 test files, 3978+ tests
...
aictl gate                         # Compile + import + version + 3978 tests + demo (~58s)
