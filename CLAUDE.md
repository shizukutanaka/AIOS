...
66 Python + 29 Go commands, 1921+ tests, zero external Python deps. v1.6.0.

## Map
```
aictl/cmd/        66 CLI commands (init doctor ps apply down recipe model ...)
...
tests/            122 test files, 1921+ tests
...
aictl gate                         # Compile + import + version + 1889 tests + demo
