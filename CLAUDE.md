...
80 Python + 29 Go commands, 3771+ tests, zero external Python deps. v1.7.0.
...
tests/            275 test files, 3771+ tests
...
aictl gate                         # Compile + import + version + 3771 tests + demo (~58s)
