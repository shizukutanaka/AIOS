...
80 Python + 29 Go commands, 3801+ tests, zero external Python deps. v1.7.0.
...
tests/            277 test files, 3801+ tests
...
aictl gate                         # Compile + import + version + 3801 tests + demo (~58s)
