...
80 Python + 29 Go commands, 4151+ tests, zero external Python deps. v1.7.0.
...
tests/            297 test files, 4151+ tests
...
aictl gate                         # 12 phases: compile, import, version, 4151 tests,
