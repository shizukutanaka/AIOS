...
80 Python + 29 Go commands, 4114+ tests, zero external Python deps. v1.7.0.
...
tests/            294 test files, 4114+ tests
...
aictl gate                         # 12 phases: compile, import, version, 4114 tests,
