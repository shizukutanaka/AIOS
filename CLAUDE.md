...
80 Python + 29 Go commands, 3882+ tests, zero external Python deps. v1.7.0.
...
tests/            281 test files, 3882+ tests
...
aictl gate                         # Compile + import + version + 3882 tests + demo (~58s)
