...
80 Python + 29 Go commands, 3856+ tests, zero external Python deps. v1.7.0.
...
tests/            280 test files, 3856+ tests
...
aictl gate                         # Compile + import + version + 3856 tests + demo (~58s)
