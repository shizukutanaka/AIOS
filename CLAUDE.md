...
69 Python + 29 Go commands, 2140+ tests, zero external Python deps. v1.6.0.

## Map
```
aictl/cmd/        69 CLI commands (init doctor ps apply down recipe model ...)
...
tests/            136 test files, 2140+ tests
...
aictl gate                         # Compile + import + version + 2140 tests + demo
