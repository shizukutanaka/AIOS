...
80 Python + 29 Go commands, 3903+ tests, zero external Python deps. v1.7.0.
...
tests/            282 test files, 3903+ tests
...
aictl gate                         # Compile + import + version + 3903 tests + demo (~58s)
